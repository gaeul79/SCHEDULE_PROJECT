 ...
 * @since 2024-10-03
 */
public class RemoveScheduleResponseDto {
    ...
    public static RemoveScheduleResponseDto from(List<ScheduleView> schedules, ResponseCode responseCode) {
        RemoveScheduleResponseDto responseScheduleDto = new RemoveScheduleResponseDto();
    ...
    public static RemoveScheduleResponseDto from(List<ScheduleView> schedules, ResponseCode responseCode, String message) {
        RemoveScheduleResponseDto responseScheduleDto = new RemoveScheduleResponseDto();
