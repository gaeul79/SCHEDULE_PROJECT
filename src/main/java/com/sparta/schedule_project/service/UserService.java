...
//     * @since 2024-10-03
//     */
//    public ResponseStatusDto login(CreateUserRequestDto requestUserDto) {
//        try {
//            User user = User.from(requestUserDto);
//            User resultUser = userRepository.findById(user);
...
//     * 회원가입을 처리합니다.
//     *
//     * @param createUserRequestDto 회원가입 요청 정보
//     * @return 회원가입 결과 (ResponseStatusDto)
//     * @author 김현정
//     * @since 2024-10-03
//     */
//    public ResponseStatusDto createUser(CreateUserRequestDto createUserRequestDto) {
//        try {
//            User user = User.from(createUserRequestDto);
...
//     * 회원 정보를 조회합니다.
//     *
//     * @param createUserRequestDto 회원 조회 요청 정보
//     * @return 회원 조회 결과 (UserResponseDto)
//     * @author 김현정
//     * @since 2024-10-03
//     */
//    public CreateUserResponseDto searchUser(CreateUserRequestDto createUserRequestDto) {
//        try {
//            User user = User.from(createUserRequestDto);
//            User resultUser = userRepository.searchUser(user);
//            return CreateUserResponseDto.from(resultUser, ResponseCode.SUCCESS_SEARCH_USER);
//        } catch (Exception ex) {
//            return CreateUserResponseDto.from(null, ResponseCode.UNKNOWN_ERROR, ex.getMessage());
//        }
//    }
//
//    /**
//     * 회원 정보를 수정합니다.
//     *
//     * @param createUserRequestDto 회원 정보 수정 요청 정보
//     * @return 회원 정보 수정 결과 (ResponseStatusDto)
//     * @author 김현정
//     * @since 2024-10-03
//     */
//    public ResponseStatusDto updateUser(CreateUserRequestDto createUserRequestDto) {
//        try {
//            User user = User.from(createUserRequestDto);
...
//     * 회원을 삭제합니다.
//     *
//     * @param createUserRequestDto 회원 삭제 요청 정보
//     * @return 회원 삭제 결과 (ResponseStatusDto)
//     * @author 김현정
//     * @since 2024-10-03
//     */
//    public ResponseStatusDto deleteUser(CreateUserRequestDto createUserRequestDto) {
//        try {
//            User user = User.from(createUserRequestDto);
